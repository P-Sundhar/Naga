...
[assembly: ExportRenderer(typeof(SecondaryEntryControl), typeof(SecondaryEntryRenderer))]
namespace SalesReturn.Droid
{
    public class SecondaryEntryRenderer : EntryRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<Entry> e)
        {
            ...
            {
                ((SecondaryEntryControl)e.NewElement).PropertyChanging += OnPropertyChanging;
            }

            if (e.OldElement != null)
            {
                ((SecondaryEntryControl)e.OldElement).PropertyChanging -= OnPropertyChanging;
            }
