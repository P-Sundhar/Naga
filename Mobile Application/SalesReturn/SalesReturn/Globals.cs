...
namespace SalesReturn
{
    public class Globals
    {
        ...
        public static string GetOutlet = "Home/GetOutlet";
        public static string GetCrateValidate = "Home/ValidateCrate";
        public static string GetBarcodeValidate = "Home/ValidateBarcode";
        public static string GetSalesReturnDetails = "Home/GetSalesReturnDetails";
        public static string SaveSalesReturn = "Home/SaveSalesReturn";
